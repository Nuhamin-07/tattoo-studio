...
export default function Appointment() {
    ...
    return (
        <main className="mt-10 px-12 py-10 shadow-lg rounded-lg"
            style={{
        ...
        >
            <div className="bg-white/60 px-6 py-10 mx-auto max-w-3xl shadow-lg rounded-lg">
                <div className="mb-10 text-center px-4 py-8 rounded-lg">
                ...
                <form className="space-y-10">
                    ...
                    <div className="mt-10">
                        <Button
                            ...
                            style={{ display: "block", margin: "70px auto 0", width: "100%" }}
                        >
                            Request Appointment
                        </Button>
                    </div>
