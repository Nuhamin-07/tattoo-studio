  ...
  return (
    <main className="w-full">
      ...
      <section className="relative min-h-[70vh] sm:min-h-[80vh] w-full overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-10 flex min-h-[70vh] sm:min-h-[80vh] items-center justify-center px-4 sm:px-6 py-16 sm:py-20 text-center">
          <div className="max-w-4xl text-white">
            <p className="mb-4 sm:mb-5 text-xs sm:text-sm font-medium uppercase tracking-[0.2em] sm:tracking-[0.25em] text-gray-300">
